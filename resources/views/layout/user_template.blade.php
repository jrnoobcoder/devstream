...
<!-- Mirrored from template.gentechtreedesign.com/html/streamlab/html/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Aug 2022 11:58:32 GMT -->
<head>
   <meta charset="utf-8">
...
<body>
   ...
   <div id="gen-loading">
      <div id="gen-loading-center">
         <img src="{{url('user/images/logo-1.png')}}" alt="loading">
      </div>
   </div>
   <!--=========== Loader =============-->
               ...
               <div class="col-lg-12">
                  <nav class="navbar navbar-expand-lg navbar-light">
                     <a class="navbar-brand" href="#">
                        <img class="img-fluid logo" src="{{url('user/images/logo-1.png')}}" alt="streamlab-image">
                     </a>
                        ...
                        <div id="gen-menu-contain" class="gen-menu-contain">
                           <ul id="gen-main-menu" class="navbar-nav ml-auto">
                              <li class="menu-item active">
                                 ...
                                 <ul class="sub-menu">
                                    <li class="menu-item active">
                                       <a href="index-2.html" aria-current="page">Main Home</a>
                                    </li>
                                    <li class="menu-item">
               ...
               <div class="row">
                  <div class="col-xl-3 col-md-6">
                     <div class="widget">
                        <div class="row">
                           <div class="col-sm-12">
                              <img src="{{url('user/images/asset-0.png')}}" class="gen-footer-logo" alt="gen-footer-logo">
                     ...
                     <div class="widget">
                        ...
                        <div class="row">
                           <div class="col-sm-12">
                              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                              <a href="#">
                                 <img src="{{url('user/images/asset-35.png')}}" class="gen-playstore-logo" alt="playstore">
                              </a>
                              <a href="#">
                                 <img src="{{url('user/images/asset-36.png')}}" class="gen-appstore-logo" alt="appstore">
                              </a>
                           </div>
                        </div>
                     </div>
   ...
   <!-- js-min -->
   <script src="{{ url('user/js/jquery-3.6.0.min.js')}}"></script>
   <script src="{{ url('user/js/asyncloader.min.js')}}"></script>
   <!-- JS bootstrap -->
   ...
   <script src="{{ url('user/js/swiper-bundle.min.js')}}"></script>
   <!-- Iscotop -->
   ...
   <script src="{{ url('user/js/streamlab-core.js')}}"></script>
...
<!-- Mirrored from template.gentechtreedesign.com/html/streamlab/html/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 28 Aug 2022 12:01:54 GMT -->
</html>